...
const char* ssid = "CANALBOX-241D-2G-ext";
const char* password = "KQU7PNKRve";

char auth[] = "QUxTc1wO7HNYqHYEb4dvTp6eZPzza2gE";  // replace this with your auth token   QUxTc1wO7HNYqHYEb4dvTp6eZPzza2gE
char sssid[] = "CANALBOX-241D-2G-ext";                        // replace this with your wifi name (SSID)
char passs[] = "KQU7PNKRve";                       // replace this with your wifi password
...
// char passs[] = "1234567890";                       // replace this with your wifi password
...
void sendSensor()  // function to read sensor values and send them to Blynk
{
  ...
  // humiditedata =  89,23; 
  //  temperaturedata = 70.00;

  Blynk.virtualWrite(V0, temperaturedata);  // send all the values to their respective virtual pins
  Blynk.virtualWrite(V1, humiditedata);
}
