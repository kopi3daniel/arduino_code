...
char phone_no[]="+243998762341"; //change +92 with country code and 3378655465 with phone number to sms
...
if(digitalRead (bt_M) == 0){sendSMS(phone_no,"Hello kopi3 Ansar from GSM SMS");}
