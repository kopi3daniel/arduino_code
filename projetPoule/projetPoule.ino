...
LiquidCrystal_I2C lcd(0X3F , 16 , 2);
 ...
 const char* ssid = "poulaillerConnecter"; 
const char* password = "poulaillerconn";  

// Identifiants du réseau WiFi
const char* sssid = "Meder";
const char* ppassword = "dynastyRB";
...
void loop() {
  ...
  jsonDocument["temperature"] = temperaturedata;
  jsonDocument["humidity"] = humiditedata;
